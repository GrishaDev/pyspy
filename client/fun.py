...
target = cwd+'\exe.win-amd64-3.5\WinPFlog.exe'
...
subprocess.Popen(cwd+'\exe.win-amd64-3.5\WinPFlog.exe')
# subprocess.Popen(r'C:\Projects\PyLoggerServer\client\build\exe.win-amd64-3.5\WinPFlog.exe')
